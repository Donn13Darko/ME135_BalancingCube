...
void fw3_PWM_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(fw3_PWM_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 fw3_PWM_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(fw3_PWM_CAPTURE_LSB_PTR));
    }
...
void fw3_PWM_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(fw3_PWM_PERIOD_LSB_PTR, period);
    #endif /* (fw3_PWM_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(fw3_PWM_COMPARE1_LSB_PTR, compare);
        #endif /* (fw3_PWM_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(fw3_PWM_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (fw3_PWM_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(fw3_PWM_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(fw3_PWM_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(fw3_PWM_COMPARE1_LSB_PTR));
        #endif /* (fw3_PWM_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(fw3_PWM_COMPARE2_LSB_PTR));
    }
...
{
    #if(fw3_PWM_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(fw3_PWM_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(fw3_PWM_PERIOD_LSB_PTR));
    #endif /* (fw3_PWM_UsingFixedFunction) */
}
